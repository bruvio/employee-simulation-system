...
class GELPolicyConstraints:
    ...
    def optimize_budget_allocation(
        self, 
        manager_interventions: Dict[int, List[Dict]]
        ...
        for manager_id, interventions in manager_interventions.items():
            ...
            optimized_allocations[manager_id] = {
                ...
                "average_adjustment": np.mean([i["recommended_adjustment"] for i in selected_interventions]) if selected_interventions else 0
            }
        ...
        self.logger.info(f"  Managers with allocations: {len([a for a in optimized_allocations.values() if a['total_interventions'] > 0])}")
    ...
    def generate_policy_summary(
        self, 
        manager_teams: Dict[int, Dict], 
        optimized_allocations: Dict[int, Dict]
    ) -> Dict[str, Any]:
    ...
    def _generate_policy_recommendations(
        ...
        avg_budget_utilization = np.mean([
            alloc.get("budget_utilization", 0) for alloc in optimized_allocations.values()
        ]) if optimized_allocations else 0
...
if __name__ == "__main__":
    ...
    sample_population = [
        {"employee_id": 1, "level": 2, "gender": "Female", "salary": 55000, "performance_rating": 4.2, "manager_id": 1001},
        {"employee_id": 2, "level": 2, "gender": "Male", "salary": 62000, "performance_rating": 3.8, "manager_id": 1001},
        {"employee_id": 3, "level": 2, "gender": "Female", "salary": 58000, "performance_rating": 4.5, "manager_id": 1001},
        {"employee_id": 4, "level": 3, "gender": "Male", "salary": 78000, "performance_rating": 3.9, "manager_id": 1002},
        {"employee_id": 5, "level": 3, "gender": "Female", "salary": 72000, "performance_rating": 4.1, "manager_id": 1002},
    ]
