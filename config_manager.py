...
class ConfigurationManager:
    ...
    def get_orchestrator_config(self, scenario: Optional[str] = None, 
    ...
    def _flatten_config(self, nested_config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        flat_config.update({
            ...
            "story_categories": story_config.get("story_categories", ["gender_gap", "above_range", "high_performer"]),
        ...
        flat_config.update({
            ...
            "run_individual_progression_analysis": analysis_config.get("run_individual_progression_analysis", False),
    ...
    def create_config_file(self, output_path: str, scenario: Optional[str] = None, 
