...
"""
    ...
    def _generate_overview_and_inputs(
        self, 
        manifest: Dict[str, Any], 
        analysis_payload: Dict[str, Any]
    ) -> str:
...
"""
    ...
    def _generate_inequality_and_risk(
        self, 
        analysis_payload: Dict[str, Any], 
        manifest: Dict[str, Any]
    ) -> str:
...
"""
    ...
    def _generate_high_performer_recognition(
        self, 
        analysis_payload: Dict[str, Any], 
        manifest: Dict[str, Any]
    ) -> str:
        ...
        "population_stratification": {
            "by_level": {
                "Level 1": {
                    "count": 45,
                    "median_salary": 32000,
                    "gender_split": "55% F / 45% M"
                },
                "Level 2": {
                    "count": 67,
                    "median_salary": 58000,
                    "gender_split": "48% F / 52% M"
                },
                "Level 3": {
                    "count": 89,
                    "median_salary": 78000,
                    "gender_split": "43% F / 57% M"
                }
            },
            "managers": {
                "total_managers": 25,
