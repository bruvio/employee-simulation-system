...
class TestGELPolicyConstraints:
    ...
    def setUp(self):
        ...
        self.sample_population = [
            ...
            {"employee_id": 6, "level": 2, "gender": "Male", "salary": 59000, "performance_rating": 3.7, "manager_id": 1001},
            {"employee_id": 7, "level": 3, "gender": "Female", "salary": 75000, "performance_rating": 4.3, "manager_id": 1002}
        ]
    ...
    def test_synthetic_hierarchy_generation(self):
        ...
        no_manager_population = [
            {"employee_id": i, "level": (i % 3) + 1, "gender": "Male", "salary": 50000 + i * 1000, "performance_rating": 3.5}
    ...
    def test_edge_cases(self):
        ...
        # Single employee
        single_employee = [{"employee_id": 1, "level": 2, "gender": "Male", "salary": 50000, "performance_rating": 3.5, "manager_id": 1001}]
...
class TestPolicyConstraintsIntegration:
    ...
    def test_large_organization_scenario(self):
        ...
        config = {
            ...
            "inequality_budget_percent": 0.3,
            "high_performer_threshold": 4.2
        }
