...
class TestRolesConfigLoader:
    ...
    def setUp(self):
        ...
        self.sample_config = {
            ...
            "currency": "GBP",
            "version": 1,
            "intervention_policy": {"max_direct_reports": 6, "inequality_budget_percent": 0.5},
            "roles": [
                {"title": "Software Engineer", "min_salaries": [65000], "headcount_hint": 5},
                {"title": "Senior Software Engineer", "min_salaries": [85000, 95000], "notes": "Multiple bands"},
            ],
        }
