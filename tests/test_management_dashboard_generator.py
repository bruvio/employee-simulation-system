...
class TestManagementDashboardGenerator:
    ...
    def setup_method(self):
                ...
                "intervention_strategies": {
                    "equity_analysis": {
                        "optimal_approach": {
                            ...
                            "temporal_breakdown": {
                                "explanation": "£100,000 over 3 years",
                                "cost_period": "three_year_plan",
                            },
                            "implementation_type": "gradual_adjustment",
                            "timeline_years": 3,
                        }
                    }
                }
        ...
        self.population_data = [
            ...
            {"employee_id": 3, "level": 4, "salary": 80000, "gender": "Female"},
        ]
        ...
        self.sample_data = {
            ...
            "gender_gap_analysis": {"current_gap": 0.15, "target_gap": 0.05, "remediation_cost": 250000},
...
class TestIntegrationScenarios:
    ...
    def setup_method(self):
        ...
        self.full_analysis_results = {
            "metadata": {"analysis_date": "2024-01-01", "population_size": 1000, "analysis_type": "comprehensive"},
            "findings": {
