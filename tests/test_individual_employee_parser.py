...
class TestEmployeeData:
    ...
    def test_salary_level_validation(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            EmployeeData(
                level=1, salary=200000, performance_rating="Achieving"  # Way too high for level 1 (28000-35000)
            )
...
class TestIndividualEmployeeParser:
    ...
    def test_parse_from_string_basic(self):
        ...
        expected = {"level": 5, "salary": 80692.5, "performance_rating": "Exceeding"}
...
class TestEdgeCases:
    ...
    def test_salary_at_level_boundaries(self):
        ...
        employee = EmployeeData(level=3, salary=95000, performance_rating="Achieving")  # Maximum for level 3
    ...
    def test_all_performance_ratings(self):
        ...
        for rating in valid_ratings:
            employee = EmployeeData(level=3, salary=75000, performance_rating=rating)
